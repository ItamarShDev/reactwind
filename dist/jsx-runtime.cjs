...
// src/jsx-runtime.ts
var jsx = (type, props, key) => (0, import_jsx_runtime.jsx)(type, withClassNames(props), key);
var jsxs = (type, props, key) => (0, import_jsx_runtime.jsxs)(type, withClassNames(props), key);
